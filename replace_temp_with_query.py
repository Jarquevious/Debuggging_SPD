...
class School:
    ...
    def print_graduate_name(self):            
        # print student's name who graduated.
        ps= self.process_graduation()
    ...
    def send_email(self):
        self.process_graduation()
        self.print_graduate_name()
        # Send congrat emails to them.
        for s in passed_students:
            print(s.send_congrat_email())
